...
\begin{oplossing}
    ...
    Als je punt \(\begin{bmatrix} x \\ y \end{bmatrix}\) wil bereiken, dan moet het stelsel
    \[
    \left\{
        \begin{array}{l}
        3h+m=x\\
    ...
    \draw[->, thick, orange!70] (0,0) -- (6,2) node[midway, below, sloped, black] {$\color{orange}2\begin{bmatrix} 3 \\ 1 \end{bmatrix}$};
    \draw[->, thick, purple!70] (0,0) -- (3,6) node[midway, above, sloped, black] {$\color{purple}3\begin{bmatrix} 1 \\ 2 \end{bmatrix}$};

    % basisvectoren hoverboard en tapijt
    \draw[->, thick, red!70] (0,0) -- (3,1) node[midway, below, sloped, black] {$\color{red}\begin{bmatrix} 3 \\ 1 \end{bmatrix}$};
    \draw[->, thick, blue!70] (0,0) -- (1,2) node[midway, above, sloped, black] {$\color{blue}\begin{bmatrix} 1 \\ 2 \end{bmatrix}$};
    
    % Resultant vector
    \draw[->, ultra thick,] (0,0) -- (9,8) node[midway, above, rotate=45, black] {$2 \begin{bmatrix} 3 \\ 1 \end{bmatrix} + 3 \begin{bmatrix} 1 \\ 2 \end{bmatrix}$};
    ...
    \end{figure}
    Formeel betekent dit dat de voortgebrachte verzameling van \(\begin{bmatrix} 3 \\ 1 \end{bmatrix}\) en \(\begin{bmatrix} 1 \\ 2 \end{bmatrix}\) het hele vlak \(\mathbb{R}^2\) is, oftewel:
    \[
    \text{span}\left\{\begin{bmatrix} 3 \\ 1 \end{bmatrix}, \begin{bmatrix} 1 \\ 2 \end{bmatrix}\right\} = \mathbb{R}^2
    \]
\end{oplossing}
\end{exercise}
...
\begin{question}
Wat is \(\text{span}\left\{\begin{bmatrix} 1 \\ 1 \\ 1 \end{bmatrix}, \begin{bmatrix} 6 \\ 3 \\ 8 \end{bmatrix}, \begin{bmatrix} 4 \\ 1 \\ 6 \end{bmatrix}\right\}\)?
En wat betekent dit in de context van de transportmodi?
\end{question}
\end{exercise}

\subsection*{Afsluiter of huistaak}
Vul de volgende tabel in met de gevraagde sets van vectoren.
