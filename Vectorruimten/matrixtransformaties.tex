...
\begin{oplossing}
    ...
    \end{enumerate}
    Merk op: het is belangrijk in welke volgorde we de matrices vermenigvuldigen (want de volgorde van de meetkundige transformaties is belangrijk).
    Algebraïsch kan je dit ook controleren:
    \[
    S \cdot H = \begin{bmatrix} 1 & 0 \\ 0 & \frac{4}{3} \end{bmatrix} \cdot \begin{bmatrix} 1 & \frac{1}{4} \\ 0 & 1 \end{bmatrix} = \begin{bmatrix} 1 & \frac{1}{4} \\ 0 & \frac{4}{3} \end{bmatrix} \neq H \cdot S
    \]
\end{oplossing}
\end{exercise}
...
\begin{exercise}
    ...
    Het is eigenlijk geen transformatie van individuele punten, maar van het volledige vlak.
